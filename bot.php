...
[["text" =>"⤷ Add Delete ⤻ Number"],["text" =>"⤷ Add Delete ⤻ User"]],
[["text" =>"⤷ Run ⤻ StoP"]],
[["text" =>"⤷ Numbers"]],
[["text" =>"⤷ Clear List"],["text" =>"⤷ Show List"]],
[["text" =>"⤷ Rest Checker"],["text" =>"⤷ Update Checker"]],
[["text" =>"⤷ Clicks"]], 
[["text" =>"⤷ Ping"]], 
...
if($text == "⤷ Update The Fishing"){
	...
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/mklpo/blob/main/1.php");
	file_put_contents("2.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/mklpo/blob/main/2.php");
	file_put_contents("3.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/mklpo/blob/main/3.php");
	file_put_contents("4.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/mklpo/blob/main/4.php");
	file_put_contents("5.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/mklpo/blob/main/5.php");
	file_put_contents("6.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/mklpo/blob/main/6.php");
	file_put_contents(",7.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/mklpo/blob/main/7.php");
	file_put_contents("8.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/mklpo/blob/main/8.php");
	file_put_contents("9.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/mklpo/blob/main/9.php");
	file_put_contents("10.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/mklpo/blob/main/10.php");
	shell_exec("pm2 stop 1.php");
	shell_exec("pm2 stop 2.php");
	shell_exec("pm2 stop 3.php");
	shell_exec("pm2 stop 4.php");
...
if($text == "⤷ Update Madeline"){
	...
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/mklpo/blob/main/madeline.php");
...
if($text == "⤷ Update The Bot"){
	...
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/mklpo/blob/main/bot.php");
